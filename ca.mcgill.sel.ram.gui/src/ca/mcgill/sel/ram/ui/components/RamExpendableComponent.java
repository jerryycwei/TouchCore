...
public class RamExpendableComponent extends RamRectangleComponent implements ActionListener {
    ...
    public void setIconsVisible(boolean visibility) {
        buttonExpand.setVisible(visibility);
        buttonCollapse.setVisible(visibility);
    }

    /**
     * Checks if the icons are visible.
     *
     * @return true, if the icons are visible
     */
    public boolean isIconsVisible() {
        return buttonExpand.isVisible() && buttonCollapse.isVisible();
    }
}
