...
public class SelectAspectScene extends RamAbstractScene<ISelectSceneHandler> {
    ...
    private static final String ACTION_FM_LOAD = "select.FM.load";
    ...
    public void actionPerformed(ActionEvent event) {
        if (handler != null) {
            ...
            if (ACTION_FM_LOAD.equals(actionCommand)) {
    ...
    protected void initMenu() {
        getMenu().addAction(Strings.MENU_CONCERN_LOAD, Icons.ICON_MENU_OPEN, ACTION_FM_LOAD, this, true);
