...
public final class Strings {
    ...
    /**
     * String used to describe use case maps.
     */
    public static final String MODEL_UCM = "UseCaseMap";
    /**
    ...
    /**
     * Defaut name of a usecasemap.
     */
    public static final String DEFAULT_UCM_NAME = "Untitled UseCaseMap";
     ...
     */
    public static final String MENU_NEW_ASPECT = "New Aspect";
    /**
    ...
    /**
     * String for the 'show re-exposed' action in {@link ca.mcgill.sel.ram.ui.scenesDisplayConcernEditScene}.
     */
    public static final String MENU_SHOW_REEXPOSED = "Show Re-exposed Features";
    /**
     * String for the 'hide re-exposed' action in {@link ca.mcgill.sel.ram.ui.scenesDisplayConcernEditScene}.
     */
    public static final String MENU_HIDE_REEXPOSED = "Hide Re-exposed Features";
    /**
    ...
    /**
     * Placeholder for UCM name. Used in DisplayUCMScene.
     */
    public static final String PH_ENTER_USE_CASE_MAP_NAME = "Enter Use Case Map Name";
     ...
     * Message when we want to reuse but the aspect was not saved.
     */
    public static final String POPUP_MUST_MAKE_VALID_SELECTION_FOR_REEXPOSED_FEATURES = "You must make valid "
            + "selections for the reexposed features.";
     ...
     */
    public static final String LABEL_ASPECT_CONTAINER = "Realisation Models";
    /**
    ...
    /**
     * Error mesage to display when user tries to create a nodeconnection between a startpoint/endpoint and a
     * startpoint/endpoint.
     *
     * @param source FromEnd pathnode
     * @param target ToEnd pathnode
     * @return the message to display.
     */
    public static String popupNodeConnectionProhibited(PathNode source, PathNode target) {
        return "A NodeConnection cannot be made between " + source.getClass().getInterfaces()[0].getSimpleName()
                + "s and "
                + target.getClass().getInterfaces()[0].getSimpleName() + "s.";
    }

    /**
     * TODO: Remove once integrate PathNodes which can have multiple successors or predecessors, such as And/Or
     * Join/Forks.
     * Error message to display when user tries to create a nodeconnection with a source that already has successors.
     *
     * @param source that already has successors.
     * @return the message to display.
     */
    public static String popupNodeConnectionHasSuccessors(PathNode source) {
        return "A NodeConnection cannot be made as " + source.getClass().getInterfaces()[0].getSimpleName()
     ...
     * TODO: Remove once integrate PathNodes which can have multiple successors or predecessors, such as And/Or
     * Join/Forks.
     * Error message to display when user tries to create a nodeconnection with a source that already has predecessors.
     *
     * @param target that already has predecessors.
     * @return the message to display.
     */
    public static String popupNodeConnectionHasPredecessors(PathNode target) {
        return "A NodeConnection cannot be made as " + target.getClass().getInterfaces()[0].getSimpleName()
                + " already has predecessors.";
    }
