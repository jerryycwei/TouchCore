...
public final class Colors {
    ...
    /**
     * Color for re-exposed features reuses in feature model edit mode.
     */
    public static final MTColor FEATURE_REUSE_REEXPOSE_FILL_COLOR = new MTColor(162, 162, 162, 255, true);
    ...
    /**
     * Color for re exposed features.
     */
    public static final MTColor FEATURE_REEXPOSED_FILL_COLOR = MTColor.YELLOW;
    /**
     ...
     * Fill color for start states in state view.
     */
    public static final MTColor PATH_NODE_FILL_COLOR = MTColor.BLACK;
