...
public final class Constants {
     ...
     */
    public static final String DIRECTORY_MODELS = ResourceUtil.getMainDirectory(Constants.class) + "models";
    ...
    /**
     * The file extension for ucm.
     */
    public static final String UCM_FILE_EXTENSION = "ucm";
    ...
    /**
     * The radius of the RamRoundedRectangleComponent in StartPointView.
     */
    public static final int START_POINT_CIRCLE_RADIUS = 25;

    /**
     * The maxSize of the container that contains the RamRoundedRectangleComponent in StartPointView.
     */
    public static final int START_POINT_CIRCLE_CONTAINER_MAX_SIZE = 50;

    /**
     * The maxSize of the ResponsibilityView.
     */
    public static final int RESPONSIBILITY_VIEW_MAX_SIZE = 50;

    /**
     * The stroke weight of the ResponsibilityView lines.
     */
    public static final int RESPONSIBILITY_VIEW_STROKE_WEIGHT = 5;

    /**
     * The height of the end point view.
     */
    public static final int END_POINT_VIEW_HEIGHT = 55;

    /**
     * The width of the end point view.
     */
    public static final int END_POINT_VIEW_WIDTH = 11;
