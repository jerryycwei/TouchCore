...
public final class Icons {
    ...
    /**
     * Icon for showing reexposed features in select mode.
     */
    public static final PImage ICON_REEXPOSED = app.loadImage(ICON_PATH + "reExposed.png");
    ...
    /**
     * Icon for showing the reexposed features from reuses in RamMenu.
     */
    public static final PImage ICON_MENU_SHOW_REEXPOSED = app.loadImage(ICON_PATH + "show_rexpose.png");

    /**
     * Icon for hiding the reuse in RamMenu.
     */
    public static final PImage ICON_MENU_HIDE_REEEXPOSED = app.loadImage(ICON_PATH + "hide_rexpose.png");
    ...
    /**
     * Icon for add a ucm in RamMenu.
     */
    public static final PImage ICON_MENU_ADD_UCM = app.loadImage(ICON_PATH + "add_ucm.png");
