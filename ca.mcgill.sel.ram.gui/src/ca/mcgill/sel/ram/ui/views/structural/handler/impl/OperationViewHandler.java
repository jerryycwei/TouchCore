...
public class OperationViewHandler extends BaseHandler implements IOperationViewHandler, ILinkedMenuListener {
    ...
    @Override
    public void setOperationStatic(OperationView operationView, ClassController controller) {
        controller.switchOperationStatic(operationView.getOperation());
    }

    @Override
    public void switchToAbstract(OperationView operationView, ClassController controller) {
        controller.switchOperationAbstract(operationView.getOperation());
    }

    @Override
    public void switchToConcernPartial(OperationView operationView, ClassController controller) {
        controller.setPartialityType(operationView.getOperation(), COREPartialityType.CONCERN);
    }

    @Override
    public void switchToNotPartial(OperationView operationView, ClassController controller) {
        controller.setPartialityType(operationView.getOperation(), COREPartialityType.NONE);
    }

    @Override
    public void switchToPublicPartial(OperationView operationView, ClassController controller) {
        controller.setPartialityType(operationView.getOperation(), COREPartialityType.PUBLIC);
    }
    ...
    public void initMenu(RamLinkedMenu menu) {
        ...
        if (operationView.isMutable()) {
            ...
            menu.addAction(Strings.MENU_PUBLIC_PARTIAL, Icons.ICON_MENU_PUBLIC_PARTIAL,
                    ACTION_OPERATION_PUBLIC_PARTIAL,
                    this, SUBMENU_CLASS_PARTIALITY, true);
            menu.addAction(Strings.MENU_CONCERN_PARTIAL, Icons.ICON_MENU_CONCERN_PARTIAL,
                    ACTION_OPERATION_CONCERN_PARTIAL,
                    this, SUBMENU_CLASS_PARTIALITY, true);
