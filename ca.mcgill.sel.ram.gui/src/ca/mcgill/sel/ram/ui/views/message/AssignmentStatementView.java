...
public class AssignmentStatementView extends ContainerComponent<ITapAndHoldListener> implements INotifyChangedListener {
    ...
    private void build() {
        ...
        assignToView.registerTapProcessor(HandlerFactoryMessageView.INSTANCE.getAssignmentAssignToHandler());
        ...
        valueView.registerTapProcessor(HandlerFactoryMessageView.INSTANCE.getValueSpecificationHandler());
        addChild(valueView);
