            ...
            if (distance >= MIN_DISTANCE) {
                ...
                if (gestureID == MTGestureEvent.GESTURE_UPDATED) {
                    ...
                    if (from != null) {
                        ...
                        if (to != null) {
                            to.highlight(false);
                            createMessage(interaction, from.getLifeline(), to.getLifeline(), container, addAtIndex,
                                    endPosition);
                        } else {
                            createLifelineWithMessage(interaction, from.getLifeline(), x, y, container, addAtIndex,
                                    endPosition);
                        }
                    }
                }
