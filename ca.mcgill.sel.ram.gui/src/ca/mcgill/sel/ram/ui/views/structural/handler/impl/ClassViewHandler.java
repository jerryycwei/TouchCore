...
public class ClassViewHandler extends ClassifierViewHandler implements IClassViewHandler {
    ...
    public void createOperation(final ClassifierView<?> classifierView) {
        ...
        keyboard.registerListener(new DefaultRamKeyboardListener() {
            ...
            public boolean verifyKeyboardDismissed() {
                try {
                    createOperation(((ClassView) classifierView).getRamClass(), index, textRow.getText());
                    operationsContainer.removeChild(textRow);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (linkedMenu != null) {
            ...
            if (ACTION_ATTRIBUTE_ADD.equals(actionCommand)) {
                ...
                switchToPublicPartial(clazz, controller);
            } else if (ACTION_CONCERN_PARTIAL.equals(actionCommand)) {
                switchToConcernPartial(clazz, controller);
            } else if (ACTION_NOT_PARTIAL.equals(actionCommand)) {
                switchToNotPartial(clazz, controller);
            } else if (ACTION_ABSTRACT.equals(actionCommand)) {
                switchToAbstract(clazz, controller);
            }
        }
    ...
    @Override
    public void switchToAbstract(ClassifierView<?> clazz, ClassController controller) {
    ...
    @Override
    public void switchToNotPartial(ClassifierView<?> clazz, ClassController controller) {
        controller.setPartialityType(clazz.getClassifier(), COREPartialityType.NONE);
    }

    @Override
    public void switchToConcernPartial(ClassifierView<?> clazz, ClassController controller) {
        controller.setPartialityType(clazz.getClassifier(), COREPartialityType.CONCERN);
    }

    @Override
    public void switchToPublicPartial(ClassifierView<?> clazz, ClassController controller) {
        controller.setPartialityType(clazz.getClassifier(), COREPartialityType.PUBLIC);
    }
