package rsbCMS.Instantiators.Authentication;
...
public class AuthenticationWorkflowInstantiator extends WorkflowInstantiator{
    ...
    public CustomizableNode _Authenticate=createCustomizableNode("rsbCMS.Steps.Authentication.EnterUserCredentials.Authenticate");
    public CustomizableNode _Block=createCustomizableNode("rsbCMS.Steps.Authentication.EnterUserCredentials.Block");
    public CustomizableNode _CheckAuthentication=createCustomizableNode("rsbCMS.Steps.Authentication.EnterUserCredentials.CheckAuthentication");
    public CustomizableNode _AskEnterCredentials=createCustomizableNode("rsbCMS.Steps.Authentication.EnterUserCredentials.AskEnterCredentials");
