package ssbCMS.Instantiators.Authentication;
...
public class AuthenticationWorkflowInstantiator extends WorkflowInstantiator{
    ...
    public CustomizableNode _Authenticate=createCustomizableNode("ssbCMS.Steps.Authentication.EnterUserCredentials.Authenticate");
    public CustomizableNode _Block=createCustomizableNode("ssbCMS.Steps.Authentication.EnterUserCredentials.Block");
    public CustomizableNode _CheckAuthentication=createCustomizableNode("ssbCMS.Steps.Authentication.EnterUserCredentials.CheckAuthentication");
    public CustomizableNode _AskEnterCredentials=createCustomizableNode("ssbCMS.Steps.Authentication.EnterUserCredentials.AskEnterCredentials");
